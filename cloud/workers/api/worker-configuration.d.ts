/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloud/workers/api/wrangler.jsonc --env-file=cloud/workers/api/release.env cloud/workers/api/worker-configuration.d.ts` (hash: 94a3d79683fb78675db628e19711fa95)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APPLE_AUDIENCES" | "AUTH_MUTATIONS_DISABLED" | "EVENT_DB_BOOKMARK_EPOCH" | "SESSION_JWT_KEYS" | "HELIUS_RPC_API_KEY" | "EVENT_PRIZE_ADMIN_PRIVATE_KEY" | "TELEGRAM_BOT_TOKEN" | "TELEGRAM_EXTRA_CHAT_ID" | "TELEGRAM_QUEUE_BRIDGE_SECRET" | "X_CLIENT_ID" | "X_CLIENT_SECRET">> {}
}
