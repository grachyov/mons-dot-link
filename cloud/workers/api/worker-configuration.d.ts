/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloud/workers/api/wrangler.jsonc --env-file=cloud/workers/api/release.env cloud/workers/api/worker-configuration.d.ts` (hash: 6e949c88a06f31da34b261b8a908bfd1)
// Runtime types generated with workerd@1.20260908.1 2026-08-09 enable_request_signal,nodejs_compat
interface __BaseEnv_Env {
	PROFILE_GAMES_DB: D1Database;
	AUTH_STATE_DB: D1Database;
	TELEGRAM_DB: D1Database;
	EVENT_PRIZE_WITHDRAWALS_DB: D1Database;
	...
	NEW_MATCH_TIMER_STORAGE: "local";
	EVENT_DB_BOOKMARK_EPOCH: "446cba4b-31c0-4c5e-8daa-af7d235fbe0f";
	SESSION_JWT_KEYS: string;
	HELIUS_RPC_API_KEY: string;
	EVENT_PRIZE_ADMIN_PRIVATE_KEY: string;
	TELEGRAM_BOT_TOKEN: string;
	TELEGRAM_EXTRA_CHAT_ID: string;
	TELEGRAM_QUEUE_BRIDGE_SECRET: string;
	X_CLIENT_ID: string;
	X_CLIENT_SECRET: string;
	INVITE_REACTIONS: DurableObjectNamespace<import("./src/index").InviteReactions>;
	EVENT_PROGRESS_WORKFLOW: Workflow<Parameters<import("./src/index").EventProgressWorkflow['run']>[0]['payload']>;
	EVENT_PRIZE_WITHDRAWAL_WORKFLOW: Workflow<Parameters<import("./src/index").EventPrizeWithdrawalWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "InviteReactions";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APPLE_AUDIENCES" | "AUTH_MUTATIONS_DISABLED" | "NEW_MATCH_TIMER_STORAGE" | "EVENT_DB_BOOKMARK_EPOCH" | "SESSION_JWT_KEYS" | "HELIUS_RPC_API_KEY" | "EVENT_PRIZE_ADMIN_PRIVATE_KEY" | "TELEGRAM_BOT_TOKEN" | "TELEGRAM_EXTRA_CHAT_ID" | "TELEGRAM_QUEUE_BRIDGE_SECRET" | "X_CLIENT_ID" | "X_CLIENT_SECRET">> {}
}
